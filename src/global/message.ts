export const Messages = {
    CMS_CREATED: 'CMS user added successfully ,The password has been sent to their email.',
    ROLE_ASSIGNED:'Role assigned successfully',
    ROLE_CREATED:'Role created successfully',
    ROLE_UPDATED:'Role updated ',
    ROLE_DELETED:'Roke deketed',
    ROLES_FETCHED: 'Roles fetched successfully.',
    ROLE_FETCHED: 'Role fetched successfully.',
    MEMBER_REGISTRED:'Member registered successfully',
